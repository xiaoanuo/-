...
@section('body')
	...
	<div class="slider">
		...
		<ul class="slides">
			<li>
				<img src="{{asset('/index/img/slide1.png')}}" alt="">
			...
			<li>
				<img src="{{asset('/index/img/slide2.png')}}" alt="">
				<div class="caption slider-content center-align">
			...
			<li>
				<img src="{{asset('/index/img/slide3.png')}}" alt="">
				<div class="caption slider-content center-align">
					<h2>FASHION SHOP</h2>
					<h4>Lorem ipsum dolor sit amet.</h4>
					<a href="" class="btn button-default">SHOP NOW</a>
	...
	<div class="section product">
		<div class="container">
			...
			<div class="row">
				...
				<div class="col s6">
					<div class="content">
						<img src="{{asset('/index/img/product-new2')}}" alt="">
			...
			<div class="row margin-bottom">
				...
				<div class="col s6">
					<div class="content">
						<img src="{{asset('/index/img/product-new4')}}" alt="">
						<h6><a href="">Fashion Men's</a></h6>
						<div class="price">
							$20 <span>$28</span>
						</div>
